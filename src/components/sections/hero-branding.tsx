...
const CRUMBL_URL = "https://giftclick.org/aff_c?offer_id=1911&aff_id=200438&source=Walmart";
    ...
    >
      <div className="relative inline-block animate-float will-change-transform">
            ...
            <div className="relative z-10 w-[240px] sm:w-[320px] mx-auto transition-transform duration-500 group-hover:scale-105">
              <img 
                src="https://i.imgur.com/ieDWflK.png" 
        ...
        <div className="relative">
            ...
            <span className="text-[#ffffff]">Walmart</span>
        ...
        <div className="flex items-center justify-center gap-2 w-full text-center">
          ...
          <p className="text-[13px] sm:text-sm md:text-[15px] text-[#ffffff]/90 font-medium leading-relaxed whitespace-nowrap font-poppins">
            Here&apos;s how to claim your <span className="text-[#ffffff] font-bold">$750 gift card</span>
          </p>
          <Sparkles className="w-3.5 h-3.5 text-[#ffc220] shrink-0 animate-sparkle" />
        </div>
      </div>
